...
import { createCourse, getCourseBySlug } from "~/server/services/courseService";
import { getAllCategories, slugify as generateSlug } from "~/server/services/categoryService";
